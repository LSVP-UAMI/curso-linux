...
+
image::putty/configuracion.png["PuTTY Configuration"]
...
image::putty/security_alert.png["Putty Security Alert"]
...
+
image::smartty/pantalla_inicio.png["Pantalla de Inicio"]
+
